...
public class Maze {
	...
	*/
	...
	{
		return getDroids().get(DroidInterface.getName());
	}
	...
	*/
	...
	//this method returns the cell of the specific coordinates
	private Cell getCell(Coordinates coordinates)
	{ 
		return maze[coordinates.getX()][coordinates.getY()][coordinates.getZ()];
	}
	
	//this method returns a boolean if the path is ok to move to
	//
	// Parameters- movefromcell - this should be the current cell that Claptrap is on
	// 			   movetocell - this shoul be the cell that claptrap is "thinking" of moving to"
